...
export function CheckCircleIcon({ color = '#4edea3' }: { color?: string }) {
  return (
...
export function CancelIcon({ color = '#ffb4ab' }: { color?: string }) {
  return (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.8" aria-hidden="true">
      <circle cx="12" cy="12" r="10" />
...
export function TerminalIcon({ size = 22 }: { size?: number }) {
  return (
...
export function SmartDisplayIcon() {
  return (
...
export function BugIcon({ size = 16 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" aria-hidden="true">
      <path d="M8 2a2 2 0 014 0" />
      <path d="M12 2a2 2 0 014 0" />
      <path d="M9 8H5M19 8h-4M5 12H3M21 12h-2M5 16H3M21 16h-2" />
      <path d="M9 8a3 3 0 006 0v8a3 3 0 01-6 0V8z" />
    </svg>
  )
}
...
export function VerifiedIcon({ size = 15 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="#4edea3" strokeWidth="1.8" aria-hidden="true">
