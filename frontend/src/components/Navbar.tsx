      ...
      <div className="h-16 max-w-7xl mx-auto px-6 lg:px-12 flex items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-3">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="hidden lg:inline-flex items-center gap-1.5 px-3 py-1.5 rounded text-[15px] font-medium transition-all active:scale-[0.98] hover:brightness-110"
            style={{
              background: '#232a34',
              color: '#dce3f0',
              fontFamily: 'Inter, sans-serif',
      ...
      {mobileOpen && (
        ...
        >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center justify-center gap-2 px-4 py-2 rounded text-[14px] font-medium transition-all"
            style={{ background: '#232a34', color: '#dce3f0', border: '1px solid #3d494c' }}
          >
